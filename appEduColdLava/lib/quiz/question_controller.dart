import 'package:appEduColdLava/quiz/scrore_screen.dart';
...
class QuestionController extends GetxController
  ...
  // Called just before the Controller is seleted from memory
  void onClose() {
    super.onClose();
  ...
  void checkAns(Question question, int selectedIndex) {
    ...
    // Once user select an ans after 2s will go to the next qn
